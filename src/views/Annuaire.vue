  ...
  data() {
    return {
      members : [
        ...
        { img:'https://www.lacuisineduweb.com/wp-content/uploads/2015/08/blzn-wwk_400x400.png', name:'Lelivrescolaire.fr', referer_firstname:'Hugo', referer_lastname: 'Arias', mail:'hugo@lelivrescolaire.com', phone:'+ 33 0 00 00 00 00', sector:'Imprimerie et routage', espace:'Cercle OL', profession:'PDG' },
